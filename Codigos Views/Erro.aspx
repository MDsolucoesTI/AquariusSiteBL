...
<body runat="server" alink="white" vlink="white" link="white" id="WebErroAcePt" style="background-color: #4079b8" >
                    ...
                    <tr>
                      ...
                      <td width="565px" height="50px">
                        <p style="font-weight: bold; font-size: 20px; color: red; font-family: Arial">
                          <br />
                          <br />
                          Ocorreu um erro de acesso a p&aacute;gina solicitada.<br />
                          <br />
                          Poder ser um erro de conex&atilde;o.<br />
                          Neste caso tente novamente mais tarde.<br />
                          <br />
                          Ou n&atilde;o existe autoriza&ccedil;&atilde;o de acesso.
                        </p>
                      </td>
                      <td height="50px"></td>
                    </tr>
