...
<body bgcolor="#ffffff">
    ...
    <div>
      <asp:Label ID="Label1" runat="server" CssClass="header" Style="vertical-align: top;
        text-align: left" Text="Manutenção de Agentes" Width="800px"></asp:Label><br />
      <table>
        <tr>
          <td style="width: 666px">
            ...
            &nbsp;<span style="color: #ff0000">* <span style="color: #000000">Campos obrigatórios</span></span>
          </td>
          <td style="width: 30px">
          </td>
            ...
            <table cellpadding="3" style="border-right: black thin solid; padding-right: 0px;
              ...
              <tr>
                <td style="width: 52px; height: 56px">
                  <asp:ImageButton ID="btnLimpa" runat="server" AlternateText="Não Gravar" BackColor="LightSlateGray"
