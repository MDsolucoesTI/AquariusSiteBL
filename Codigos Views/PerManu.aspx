...
<script runat="server">
  ...
  Protected Sub btnVoltar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
    Response.Redirect("IniPerson.aspx")
  End Sub
</script>
...
<body bgcolor="#ffffff">
    ...
    <div>
      <asp:Label ID="Label1" runat="server" CssClass="header" Text="Manuten��o de Pessoas"
        Width="800px" style="vertical-align: top; text-align: left"></asp:Label>
      <table>
        <tr>
          <td style="width: 666px">
      <table id="TABLE1" onclick="return TABLE1_onclick()" style="border-right: black thin solid; border-top: black thin solid; margin: 10px; border-left: black thin solid; border-bottom: black thin solid">
        <tr>
          ...
          <td align="left" style="width: 124px; height: 26px" valign="middle">
            <asp:TextBox ID="ID" runat="server" Columns="10" CssClass="entrada"></asp:TextBox><span style="color: #ff0000">*</span></td>
          <td align="left" style="width: 482px; height: 26px" valign="middle">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="ID"
              ErrorMessage="You must enter a ID" CssClass="alerta"></asp:RequiredFieldValidator></td>
        </tr>
        <tr>
          <td align="left" style="width: 62px; height: 26px;" valign="middle">
          ...
          <td align="left" style="width: 124px; height: 26px;" valign="middle">
            <asp:TextBox ID="Name" runat="server" Columns="40" CssClass="entrada"></asp:TextBox><span style="color: #ff0000">*</span></td>
          <td align="left" style="width: 482px; height: 26px;" valign="middle">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="You must enter a name" ControlToValidate="Name" CssClass="alerta"></asp:RequiredFieldValidator></td>
        </tr>
        <tr>
          <td align="left" style="width: 62px" valign="middle">
            <span style="color: #ff0000">
              <asp:Label ID="Label4" runat="server" CssClass="normal" Text="Type:"></asp:Label></span></td>
          <td align="left" style="width: 124px; color: #ff0000;" valign="middle">
            <asp:DropDownList ID="Type" runat="server" CssClass="entrada">
          ...
          <td align="left" style="width: 482px" valign="middle">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="You must enter a Type" ControlToValidate="Type" CssClass="alerta"></asp:RequiredFieldValidator></td>
        </tr>
        <tr>
          <td align="left" style="width: 62px" valign="middle">
            <asp:Label ID="Label5" runat="server" CssClass="normal" Text="Adress:"></asp:Label></td>
          <td align="left" style="width: 124px" valign="middle">
            <asp:TextBox ID="Adress" runat="server" Columns="45" CssClass="entrada"></asp:TextBox><span style="color: #ff0000">*</span></td>
          <td align="left" style="width: 482px" valign="middle">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="You must enter a adress" ControlToValidate="Adress" CssClass="alerta"></asp:RequiredFieldValidator></td>
        </tr>
        <tr>
          <td align="left" style="width: 62px" valign="middle">
            <asp:Label ID="Label6" runat="server" CssClass="normal" Text="City:"></asp:Label></td>
          <td align="left" style="width: 124px" valign="middle">
            <asp:TextBox ID="City" runat="server" Columns="30" CssClass="entrada"></asp:TextBox><span style="color: #ff0000">*</span></td>
          <td align="left" style="width: 482px" valign="middle">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="You must enter a city" ControlToValidate="City" CssClass="alerta"></asp:RequiredFieldValidator></td>
        </tr>
        <tr>
          <td align="left" style="width: 62px" valign="middle">
            <asp:Label ID="Label7" runat="server" CssClass="normal" Text="Country:"></asp:Label></td>
          <td align="left" style="width: 124px" valign="middle">
            <asp:TextBox ID="Country" runat="server" Columns="30" CssClass="entrada"></asp:TextBox><span style="color: #ff0000">*</span></td>
          <td align="left" style="width: 482px" valign="middle">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="You must enter a country" ControlToValidate="Country" CssClass="alerta"></asp:RequiredFieldValidator></td>
        </tr>
        <tr>
          <td align="left" style="width: 62px" valign="middle">
            <asp:Label ID="Label8" runat="server" CssClass="normal" Text="Tel:"></asp:Label></td>
          <td align="left" style="width: 124px" valign="middle">
            <asp:TextBox ID="Tel" runat="server" Columns="20" CssClass="entrada"></asp:TextBox><span style="color: #ff0000">*</span></td>
          <td align="left" style="width: 482px" valign="middle">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="You must enter a telephone" ControlToValidate="Tel" CssClass="alerta"></asp:RequiredFieldValidator></td>
        </tr>
        <tr>
          <td align="left" style="width: 62px" valign="middle">
        ...
        <tr>
          ...
          <td align="left" style="width: 124px" valign="middle">
            <asp:TextBox ID="EMail" runat="server" Columns="40" CssClass="entrada"></asp:TextBox><span style="color: #ff0000">*</span></td>
          <td align="left" style="width: 482px" valign="middle">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="You must enter a E-mail" ControlToValidate="EMail" CssClass="alerta"></asp:RequiredFieldValidator></td>
        </tr>
        <tr>
          <td align="left" style="width: 62px" valign="middle">
      ...
      &nbsp;<span style="color: #ff0000">* <span style="color: #000000">Campos obrigat�rios</span></span>
          ...
          <td style="width: 51px; vertical-align: top; text-align: left;">
            <table cellpadding="3" style="border-right: black thin solid; padding-right: 0px;
              ...
              <tr>
                <td style="width: 52px; height: 56px">
                  <asp:ImageButton ID="btnVoltar" runat="server" AlternateText="Voltar" BorderStyle="Solid" BorderWidth="1px" ImageUrl="Imgs/Voltar.png" OnClick="btnVoltar_Click" /></td>
              </tr>
            </table>
          </td>
        </tr>
