...
<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Restrito.aspx.vb" Inherits="Restrito" %>
                        ...
                        <table>
                          <tr>
                            <td width="137px" height="34px" valign="middle">
                              <asp:HyperLink ID="linLineUp" NavigateUrl="Cliente.aspx" runat="server">
                          ...
                          <tr>
                            <td width="137px" height="34px" valign="middle">
                              <asp:HyperLink ID="linDocumento" NavigateUrl="Cliente.aspx" runat="server">
                          ...
                          <tr>
                            <td width="137px" height="34px" valign="middle">
                              <asp:HyperLink ID="linMensagem" NavigateUrl="EnviarEmail.aspx" runat="server" >
                          ...
                          <tr>
                            <td width="137px" height="34px" valign="middle">
                              <asp:HyperLink ID="linCadastro" NavigateUrl="Cadastro.aspx" runat="server">
                          ...
                          <tr>
                            <td width="137px" height="34px" valign="middle">
                              <asp:HyperLink ID="linViagem" NavigateUrl="Viagem.aspx" runat="server">
                          ...
                          <tr>
                            <td width="137px" height="34px" valign="middle">
                              <asp:HyperLink ID="linRetorno" NavigateUrl="Default.aspx" runat="server">
